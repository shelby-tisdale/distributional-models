...
\*\*Note: Gaps in centile curves represent ages (by months) for which we
don't have data. Leave values for which you don't have data as 0.
...
plot_centile <- function(
  ...
  "log(max/centile value)"
    ...
    else{"cortical surface area (mm^2)"}
  }
