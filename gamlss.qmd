...
# plot centiles
ggplot(data = brain_data |> filter(sex != "Intersex-Male")) +
  geom_point(aes(x = interview_age, y = area , color = sex), size = 1, alpha = 0.05, show.legend = FALSE) +
  geom_line(data = centile_data_male, aes(x = x, y = c.1), size = 1.5, linetype = "dashed", color = "steelblue2") + 
  geom_line(data = centile_data_male, aes(x = x, y = c.2), size = 1.5, color = "steelblue2") +
  geom_line(data = centile_data_male, aes(x = x, y = c.3), size = 1.5, linetype = "dashed", color = "steelblue2") +
  geom_line(data = centile_data_female, aes(x = x, y = c.1), size = 1.5, linetype = "dashed", color = "tomato1") + 
  geom_line(data = centile_data_female, aes(x = x, y = c.2), size = 1.5, color = "tomato1") +
  geom_line(data = centile_data_female, aes(x = x, y = c.3), size = 1.5, linetype = "dashed", color = "tomato1") +
